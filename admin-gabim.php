					...
					<div class="row min-height">
						...
						<div class="col-lg-9 mx-auto  text-center d-flex justify-content-center align-items-center">
							<div class="card justify-content-center align-items-center ">
								...
								<span class="bg-danger d-flex flex-wrap justify-content-center align-items-center p-2 my-2"><i class="fas fa-radiation-alt"></i><h5 class="mx-1">nuk gjendeni<br> admin</h5></span>
								<div class="card-body mx-auto">
									
									<form  class="my-3" method="POST" action="ad.php">
							...
							<div class="input-group my-2">
								...
								<input value="login"  class="btn  btn-regj btn-outline-danger" onclick="return validate();" type="submit" >
