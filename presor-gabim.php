		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse justify-content-end" id="myNav">
				<ul class="navbar-nav  ">
					...
					<li class="nav-item">
						<a href="loginpresor.php"  class="nav-link">
					...
					<div class="row min-height">
						...
						<div class="col-lg-9 mx-auto  text-center d-flex justify-content-center align-items-center">
							<div class="card justify-content-center align-items-center ">
								...
								<span class="bg-danger d-flex flex-wrap justify-content-center align-items-center p-2 my-2"><i class="fas fa-radiation-alt"></i><h5 class="mx-1">nuk gjendeni <br> profesor</h5></span>
								<div class="card-body mx-auto">
									
						<form  class="my-3" method="POST" name="myForm"   onsubmit="return validateForm()" action="login-presor.php">
								
							<div class="input-group my-2">
									<h5 class=" px-2 ml-3">Jep emer  :</h5>
									<input type="text" class="form-control pas mx-3 " id="emer" name="presor_emer" placeholder="jep emer">
								...
								<div class=" my-2 input-group d-flex  ">
									...
									<input type="password" class="form-control mx-3" name="presor_password" id="password" placeholder="jep password">
									
									
								</div>
								
								<input value="login"  class="btn  btn-regj btn-outline-danger" name="login"  type="submit" >
...
<script src="jquery-3.4.1.min.js"></script>
  ...
  var x = document.forms["myForm"]["presor_emer"].value;
  if (x == "") {
